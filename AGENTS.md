...
- The shader should be as small as possible. Keep the live state as small as possible to avoid increasing register allocation.
- Keep variable names terse. `ray_dir` instead of `ray_direction`.
- Don't worry about code duplication. Prefer fewer functions over a bunch of small functions which call each other.
